...
- V6.4 hỗ trợ 2 cách đọc dữ liệu:
...
V6.4: Chuyển trạng thái nguồn dữ liệu + Mở Sheet + Cập nhật vào nút ⚙️ Cài đặt. Không còn chiếm chỗ trên màn hình chính. Cấu hình biến môi trường để dành sau khi chốt app.
